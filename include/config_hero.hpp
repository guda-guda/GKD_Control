...
namespace Config
{
    ...
    inline Chassis::ChassisConfig* chassis_config = new Chassis::ChassisConfig {
        .wheels_config = {
    ...
    inline Gimbal::GimbalConfig* gimbal_left_config = nullptr;

    inline Gimbal::GimbalConfig* gimbal_right_config = new Gimbal::GimbalConfig {
