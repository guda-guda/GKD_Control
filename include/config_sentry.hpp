...
namespace Config
{
    ...
    const Chassis::ChassisConfig* chassis_config = new Chassis::ChassisConfig {
        .wheels_config = {
    ...
    const Gimbal::GimbalConfig* gimbal_left_config = new Gimbal::GimbalConfig {
    ...
    const Gimbal::GimbalConfig* gimbal_right_config = new Gimbal::GimbalConfig {
